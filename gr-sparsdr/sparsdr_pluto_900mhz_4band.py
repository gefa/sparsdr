...
# Title: Sparsdr Pluto 900Mhz 4Band
...
class sparsdr_pluto_900mhz_4band(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Sparsdr Pluto 900Mhz 4Band")
        ...
        self.samp_rate_r3 = samp_rate_r3 = 2.5*800e3
        ...
        self.taps_r3 = taps_r3 = firdes.low_pass(1,samp_rate_r3,150e3,50e3,firdes.WIN_HAMMING)
        ...
        self.zeromq_push_msg_sink_0_1 = zeromq.push_msg_sink('tcp://127.0.0.1:5560', 100, True)
        self.zeromq_push_msg_sink_0_0_0 = zeromq.push_msg_sink('tcp://127.0.0.1:5558', 100, True)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.lora_sdr_hier_rx_0_0 = lora_sdr.hier_rx(125000, 125000, 7, impl_head, cr, pay_len, True, True)
        ...
        self.digital_clock_recovery_mm_xx_0 = digital.clock_recovery_mm_ff(int(samp_rate/100000), 0.25*0.175*0.175, 0.5, 0.175, 0.005)
        ...
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf(2*(samp_rate_r3)/(2*math.pi*20e3/8.0))


        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.lora_sdr_hier_rx_0, 'msg'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.lora_sdr_hier_rx_0, 'msg'), (self.zeromq_push_msg_sink_0_0_0, 'in'))
        self.msg_connect((self.lora_sdr_hier_rx_0_0, 'msg'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.zwave_packet_sink_0, 'out'), (self.blocks_message_debug_0_0, 'print_pdu'))
        self.msg_connect((self.zwave_packet_sink_0, 'out'), (self.zeromq_push_msg_sink_0, 'in'))
        self.msg_connect((self.zwave_packet_sink_0_0, 'out'), (self.blocks_message_debug_0_0, 'print_pdu'))
        self.msg_connect((self.zwave_packet_sink_0_0, 'out'), (self.zeromq_push_msg_sink_0_1, 'in'))
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.lora_sdr_hier_rx_0_0, 0))
        self.connect((self.digital_binary_slicer_fb_0, 0), (self.zwave_packet_sink_0, 0))
        self.connect((self.digital_binary_slicer_fb_0_0, 0), (self.zwave_packet_sink_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0_0_0_0, 0), (self.blocks_complex_to_float_0, 0))
        self.connect((self.variable_sparsdr_combined_pluto_receiver_0, 2), (self.analog_quadrature_demod_cf_0, 0))
        ...
        self.connect((self.variable_sparsdr_combined_pluto_receiver_0, 3), (self.rational_resampler_xxx_0_0_0_0_0, 0))
    ...
    def get_samp_rate_r3(self):
        return self.samp_rate_r3

    def set_samp_rate_r3(self, samp_rate_r3):
        self.samp_rate_r3 = samp_rate_r3
        self.set_taps_r3(firdes.low_pass(1,self.samp_rate_r3,150e3,50e3,firdes.WIN_HAMMING))
        self.analog_quadrature_demod_cf_0.set_gain(2*(self.samp_rate_r3)/(2*math.pi*20e3/8.0))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate_r3, 2.5*40e3, 10e3, firdes.WIN_HAMMING, 6.76))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.digital_clock_recovery_mm_xx_0.set_omega(int(self.samp_rate/100000))
    ...
    def get_taps_r3(self):
        return self.taps_r3

    def set_taps_r3(self, taps_r3):
        self.taps_r3 = taps_r3
...
def main(top_block_cls=sparsdr_pluto_900mhz_4band, options=None):
    tb = top_block_cls()
